...
import { YStack, XStack, Text, Button, Input, Spinner, ScrollView, CheckCircle, Circle } from 'tamagui'
...
export default function NewIntentionPage() {
  ...
  const createMutation = trpc.intention.create.useMutation()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/discover/intentions')
    } catch (error: any) {
      ...
      <YStack padding="$4" maxWidth={800} marginHorizontal="auto" gap="$4">
        <YStack gap="$2" marginBottom="$4">
          ...
          <Text fontSize="$3" color="#8B7E74">
            Definiera vad du söker och vilka egenskaper som är viktiga för dig
          </Text>
        </YStack>
            ...
            <XStack gap="$3">
              ...
              >
                <Text color="white" fontWeight="600">
                  {isSubmitting ? 'Skapar...' : 'Skapa intention'}
                </Text>
              </Button>
