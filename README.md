...
F01 scaffolding, F03 database & infrastructure, F04 profiles, F05 social feed, F06 interest groups, F07 AI gatekeeper, F08 matching, F10 voice & video calls, F12 organizations, F14 ConsentVault, F15 coach engine, F17 spicy coaching, F18 gamification, F19 sexual health education, F20 marketplace, F25 dual mode (Vanilla/Spicy toggle), F30 auth fix (Swish+SPAR identity verification, email/password login, Google+Apple OAuth — BankID removed), **F05-stitch-design** (stitch design system — "The Digital Boutique Hotel": glassmorphic floating nav, Noto Serif + Manrope typography, no-line rule, copper-gold gradients, tonal layering, ultra-diffused shadows, ghost borders) complete. See `.bmad/STATUS.md` for full feature roadmap.
